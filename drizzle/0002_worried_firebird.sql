...
--> statement-breakpoint
ALTER TABLE "integrations" ADD COLUMN "team_id" text NOT NULL;--> statement-breakpoint
ALTER TABLE "workflows" ADD COLUMN "team_id" text NOT NULL;--> statement-breakpoint
