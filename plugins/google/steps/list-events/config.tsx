...
export function ListGoogleEventsConfigFields({
  config,
  onUpdateConfig,
  disabled,
}: {
  ...
  return (
    <div className="space-y-3">
      <div className="space-y-2">
        <Label htmlFor="google-calendar-id">Calendar ID (optional)</Label>
        <Input
          disabled={disabled}
      ...
      <div className="space-y-2">
        <Label htmlFor="google-time-min">Time Min (ISO)</Label>
        <Input
          disabled={disabled}
          id="google-time-min"
      ...
      <div className="space-y-2">
        <Label htmlFor="google-time-max">Time Max (ISO)</Label>
        <Input
          disabled={disabled}
          id="google-time-max"
      ...
      <div className="space-y-2">
        <Label htmlFor="google-events-max">Max Results</Label>
        <Input
          disabled={disabled}
          id="google-events-max"
